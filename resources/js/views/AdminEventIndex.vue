    ...
    <div id="layout-dashboard">
        ...
        <section class="organization-container">
           <div class="alert-no-data" v-if="!this.content['organizations'].length">
                <p class="alert-text text-body-display">{{ $t('admin.text.noSubscriptions') }}</p>
            </div>
            <div class="table" v-else  v-bind:class="{ 'table-loading': loading}">
                <div class="table-header">
                    <ul class="table-list">
                        ...
                        <li class="table-item grid-2">
                             <span href="#" class="text-subhead btn-filter" @click.prevent="openActions">
                                  ...
                                  <form autocomplete="off" class="form-filters" @submit.prevent>
                                    <div class="form-group form-group-filters">
                                        <div class="form-checkbox-container">
                                            <input id="filter_not_submitted" class="form-checkbox-input" type="checkbox" value="1" v-model="filters" v-on:change="filterStatus()">
                                            <label class="form-checkbox-label text-body-display" for="filter_not_submitted">
                                    ...
                                    <div class="form-group  form-group-filters">
                                        <div class="form-checkbox-container">
                                            <input id="filter_to_be_reviewed" class="form-checkbox-input" type="checkbox" value="2" v-model="filters" v-on:change="filterStatus()">
                                            <label class="form-checkbox-label text-body-display" for="filter_to_be_reviewed">
                                    ...
                                    <div class="form-group  form-group-filters">
                                        <div class="form-checkbox-container">
                                            <input id="filter_waiting_payment" class="form-checkbox-input" type="checkbox" value="3" v-model="filters" v-on:change="filterStatus()">
                                            <label class="form-checkbox-label text-body-display" for="filter_waiting_payment">
                                    ...
                                    <div class="form-group  form-group-filters">
                                        <div class="form-checkbox-container">
                                            <input id="filter_paid" class="form-checkbox-input" type="checkbox" value="4" v-model="filters" v-on:change="filterStatus()">
                                            <label class="form-checkbox-label text-body-display" for="filter_paid">
                                    ...
                                    <div class="form-group  form-group-filters">
                                        <div class="form-checkbox-container">
                                            <input id="filter_waiting" class="form-checkbox-input" type="checkbox" value="5" v-model="filters" v-on:change="filterStatus()">
                                            <label class="form-checkbox-label text-body-display" for="filter_waiting">
                ...
                <div class="table-body">
                    <ul class="table-list table-list-body" v-for="organization in this.content['organizations']" v-bind:key="organization.id">
                        <li  class="table-item grid-3">
                         ...
                         <li class="table-item grid-2">
                                 <div :class="`status status-${organization.subscriptions[0].status.type}`">
                                    <span class="text-subhead">{{organization.subscriptions[0].status.admin_label}}</span>
                                </div>
                        </li>
                         ...
                         <li  class="table-item grid-2">
                            ...
                            <div class="table-menu" @click.prevent="openActions">
                             ...
                             <div class="actions-container">
                                <a href="#" @click.prevent="deleteSubscription(organization.subscriptions[0].id)" class="action action-table">
                        ...
                        <router-link :to="{ name: 'admin.subscription', params: {event: getEvent(), subscription_id: organization.subscriptions[0].id}}" class="">
                            </router-link>
                        </li>
                    </ul>
                </div>
...
export default {
    ...
    beforeRouteEnter (to, from, next) {
      store.dispatch('admin/subscriptions', to.params.event)
        .then(next)
