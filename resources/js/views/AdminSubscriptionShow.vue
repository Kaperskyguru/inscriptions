        ...
        <div id="layout-dashboard">
            ...
            <header class="subscription-header">
                <div class="status-container">
                    <div
                        :class="
                            `status status-${this.content['organizations'].subscriptions[0].status.type}`
                        "
            ...
            <div class="tabs">
                <div class="tab active" data-tab="inscriptions">
                    <section class="export-container">
                        ...
                        <div class="export-actions">
                            <a
                                :href="
                                    `/api/v1/admin/export/schedule/organization/${this.content['organizations'].subscriptions[0].id}/${this.content['organizations'].id}?token=${accesstoken}`
                                "
                                target="_blank"
                    ...
                    <section
                        ...
                        :set="
                            (subscription = this.content['organizations']
                                .subscriptions[0])
                        "
                    >
                            ...
                            <div class="table-body">
                                ...
                                >
                                    ...
                                    <li class="table-item grid-2">
                                        <span
                                            class="table-text text-body-display"
                                            >{{ routine.category.name }}</span
                                        >
                                    </li>
                                    <li class="table-item grid-2">
                                        <span
                                            class="table-text text-body-display"
                                            >{{ routine.level.name }}</span
                                        >
                                    </li>
                                    <li class="table-item grid-2">
                                        <span
                                            class="table-text text-body-display"
                                            >{{ routine.style.name }}</span
                                        >
                                    </li>
                                    <li class="table-item grid-2">
                                        <span
                                            class="table-text text-body-display"
                                            >{{ routine.dancers.length }}</span
                                        >
                                        <div
                                            class="table-menu"
                                            @click.prevent="openActions"
              ...
              >Exporter</export-excel>-->
                            ...
                            <a
                                :href="
                                    `/api/v1/admin/export/subscription/${this.content['organizations'].subscriptions[0].id}?token=${accesstoken}`
                                "
                                target="_blank"
                                class="btn btn-primary btn-inverted"
                                >Exporter</a
                            ...
                            <router-link
                                :to="{
                                    ...
                                    params: {
                                        ...
                                        id: this.content['organizations']
                                            .subscriptions[0].id,
                                        organization_id: this.content[
                                            'organizations'
                                        ].id
                                    }
                                }"
                    ...
                    >
                        ...
                        <div class="table" v-if="subscription.routines.length">
                            <div class="table-header">
                                <ul class="table-list">
                                    ...
                                    <li class="table-item grid-2">
                                        <span class="text-subhead">{{
                                            $t(
                                                "dashboard.table.title.unit_cost"
                                            )
                                        }}</span>
                                    </li>
                                    <li class="table-item grid-2">
                                        <span class="text-subhead">{{
                                            $t(
                                                "dashboard.table.title.total_cost"
                                            )
                                        }}</span>
                                    </li>
                                </ul>
                            ...
                            <div class="table-body">
                                <ul
                                    class="table-list table-list-body"
                                    v-for="category in this.content[
                                        'categories'
                                    ]"
                                ...
                                >
                                    ...
                                    <li class="table-item grid-2">
                                        <span
                                            class="table-text text-body-display"
                                            >{{ category.routines_count }}</span
                                        >
                                    </li>
                                    <li class="table-item grid-2">
                                        <span
                                            class="table-text text-body-display"
                                            >{{ category.entries }}</span
                                        >
                                    </li>
                                    <li class="table-item grid-2">
                                        <span
                        ...
                        <ul class="invoice-list-total">
                            ...
                            >
                                ...
                                >
                                <span class="invoice-int grid-3"
                                    >{{ subscription.tvh }} $</span
                                >
                            </li>
                            <li
                                class="invoice-item invoice-total text-body-display"
                            >
                                <span class="invoice-data grid-4">{{
                        ...
                        <div class="export-actions">
                            ...
                            <form
                                ...
                                v-if="
                                    this.content['organizations']
                                        .subscriptions[0].status_id == 1 ||
                                        this.content['organizations']
                                            .subscriptions[0].status_id == 2 ||
                                        this.content['organizations']
                                            .subscriptions[0].status_id == 5
                                "
                            >
                                <button
                                ...
                                >
                                    <div class="floating-label-container">
                                        ...
                                        <label
                                            ...
                                            >{{
                                                $t(
                                                    "forms.label.organizationAccronyme"
                                                )
                                            }}</label
                                        >
                                    </div>
                                    <p
                                        v-show="errors.has('accronyme')"
                                        class="form-msg-error"
                                    >
                                ...
                                >
                                    <div class="floating-label-container">
                                        ...
                                        <label
                                            ...
                                            >{{
                                                $t(
                                                    "forms.label.organizationAddress"
                                                )
                                            }}</label
                                        >
                                    </div>
                                ...
                                >
                                    <div class="floating-label-container">
                                        ...
                                        <label
                                            ...
                                            >{{
                                                $t(
                                                    "forms.label.organizationZipcode"
                                                )
                                            }}</label
                                        >
                                    </div>
                ...
                <div class="tab tab-dancers" data-tab="dancers">
                    <section
                        ...
                        :set="(dancers = this.content['organizations'].dancers)"
                    >
                            ...
                            <div class="table-header">
                                <ul class="table-list">
                                    <li class="table-item grid-3">
                                        <span class="text-subhead">{{
                                            $t(
                                                "dashboard.table.title.firstName"
                                            )
                                        }}</span>
                                    </li>
                                    <li class="table-item grid-3">
                            ...
                            <div class="table-body">
                                ...
                                >
                                    <li class="table-item grid-3">
                                        <span
                                            class="table-text text-body-display"
                                            >{{ dancer.first_name }}</span
                                        >
                                    </li>
                                    <li class="table-item grid-3">
                                        <span
                                            class="table-text text-body-display"
                                            >{{ dancer.last_name }}</span
                                        >
                                    </li>
                                    <li class="table-item grid-3">
                                        <span
                                            class="table-text text-body-display"
                                            >{{ dancer.date_of_birth }}</span
                                        >
                                    </li>
                                    <li class="table-item grid-3">
                                        <span
...
export default {
    ...
    methods: {
        ...
        getRoutineData() {
            ...
            this.content["organizations"].subscriptions[0].routines.map(
                function(routine, key) {
                    let obj = {};
        ...
        editPayment(id, ev) {
            let payments = this.content["organizations"].subscriptions[0]
                .payments;
            ...
            ev.currentTarget.parentNode.parentNode.classList.remove(
                "has-menu-open"
            );
        },
        showPaymentModal(ev) {
