...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    ...
    store.dispatch('subscriptions/show', to.params.id)
        .then( _ => {
                 store
        ...
        .catch(error => {
            ...
            store.dispatch('feedback/setDelayedFeedback', {message: error.data.msg, type: 'warning'})
        });
  ...
  created() {
    this.routine.style_id = this.routineData.styles[0].id;
  }
};
</script>
